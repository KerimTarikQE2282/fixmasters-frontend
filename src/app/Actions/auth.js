...
import {
   ...
   export const checkAuthenticated= () => async dispatch =>{
        if(localStorage.getItem('access')){
            ...
            try{
                const res=await axios.post(`http://localhost:3001/auth/jwt/verify/`,body , config)
    ...
    export const login = (email, password) => async dispatch => {
        ...
        try {
            const res = await axios.post(`http://localhost:3001/api/v1/CustomerAuth/login`, body, config);
